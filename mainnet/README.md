...
A headless example of how to use the Blink gas sponsored swap service on Ethereum mainnet using 0x as your swap provider.

Demonstrates the following:

1. Get an indicative price (sell 0.1 USDC → buy WETH) using 0x's `/swap/allowance-holder/price`
2. Get a firm quote (sell 0.1 USDC → buy WETH) using 0x's `/swap/allowance-holder/quote`
